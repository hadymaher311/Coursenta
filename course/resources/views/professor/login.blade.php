		...
		<div class="row align-items-center full" style="padding: 30px 0;">
			<div class="col-md-5 ml-auto mr-auto">
				@if (session('status'))
			  	...
			  	@endif
				<h2 class="text-center">Professors Login</h2>
				<form method="POST" action="{{ route('professor.login') }}">
					...
					<a href="{{ route('professor.password.request') }}">Forget your password</a>
					...
					<div class="text-center">
						...
						<a href="{{ route('login') }}" class="btn btn-outline-purple wow fadeInRight" data-wow-delay="1.5s">
