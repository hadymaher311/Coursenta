        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <form action="{{ url('employee/photo') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="settings">
                ...
                <form class="form-horizontal" action="{{ url('/employee/update') }}" method="POST">
                	{{ csrf_field() }}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="inputUserName" placeholder="Username" value="{{ Auth::user()->username }}" required name="username">
                    </div>
                  </div>
