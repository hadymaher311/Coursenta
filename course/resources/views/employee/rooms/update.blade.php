...
@section('head')
  ...
  <link rel="stylesheet" href="{{ asset('/employee_style/css/all.css') }}">
@endsection
	...
	<section class="content">
	      <div class="row">
	        <div class="col-xs-12">
                ...
                <form class="form-horizontal" action="{{ url('/employee/rooms/' . $room->number . '/edit') }}" method="POST">
                	{{ csrf_field() }}
                  {{ method_field('PATCH') }}
...
@section('footer')
  ...
  <!-- iCheck 1.0.1 -->
  <script src="{{ asset('/employee_style/js/icheck.min.js') }}"></script>
