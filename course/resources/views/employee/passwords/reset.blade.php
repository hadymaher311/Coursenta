    ...
    <div class="container">
        <div class="row align-items-center full" style="padding: 30px 0;">
            <div class="col-md-5 ml-auto mr-auto">
                ...
                @endif
                <h2 class="text-center wow fadeInRight">Employee Reset Password</h2>
                <form method="POST" action="{{ route('employee.password.request') }}">
                    ...
                    <div class="md-form">
                        ...
                        <label for="form5" data-error="password must be more than 6 characters" data-success="right">Confirm Password</label>
                    </div>
